	...
	intersectionGrid.eachPoint(function(point, x, y) {
		...
		while( !stamped ) {
			...
			if( !data.empty.x ) {
				...
				} else if( rightNghbrData && (rightNghbrData.type.x == data.type.x || rightNghbrData.type.y == data.type.x) ) {
			...
			if( !data.empty.y ) {
				...
				} else if( downNghbrData && (downNghbrData.type.x == data.type.y || downNghbrData.type.y == data.type.y) ) {
			...
			//let hasTypeNeighbor = upNghbrData && (upNghbrData.type.y == data.type.y) && leftNghbrData && (leftNghbrData.type.x == data.type.x);

			// Set intersections
			if( upNghbrData && !upNghbrData.empty.y && leftNghbrData && !leftNghbrData.empty.x && !data.empty.x && !data.empty.y ) { // && hasTypeNeighbor
